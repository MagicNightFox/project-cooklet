...
import { reauthenticateWithCredential, reauthenticateWithPopup, EmailAuthProvider, updateProfile } from "firebase/auth";
...
return(<div className={styles.body}>
    ...
    <div className={styles.title_container}>
      <p className={styles.title}>Change Username</p>
      <div className={styles.subtitle}>Zadejte prosím své nové jméno a potvrďte heslem.</div>
    </div>
    ...
    <button title="Change username" onClick={confirmChange} className={styles.change_btn}>
  ...
  : <div className={styles.form_container}>
    <div className={styles.title_container}>
      <p className={styles.title}>Change Username</p>
      <div className={styles.subtitle}>Zadejte prosím své nové jméno a potvrďte google účtem.</div>
    </div>
    <div className={styles.input_container}>
      <label className={styles.input_label} htmlFor="username_field">Username</label>
      <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={styles.icon}>
