...
function EmailChange({onSent}){
    ...
    function confirmChange(e){
        ...
        fetchSignInMethodsForEmail(auth, email).then(async (signInMethods) => {
            if(signInMethods.length >0){
                console.error("Email address is already in use");
                alert("Emailová adresa je již používaná.");
            }
            else{
...
return(<div className={styles.body}>
  ...
  <div className={styles.title_container}>
    ...
    <div className={styles.subtitle}>Zadejte prosím svůj nový email a potvrďte heslem.</div>
  </div>
  ...
  <button title="Change email" onClick={confirmChange} className={styles.change_btn}>
