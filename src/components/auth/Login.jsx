...
<div className={styles.input_container}>
  ...
  <input placeholder="name@mail.com" title="Input title" name="input-name" type="email" className={styles.input_field} id="email_field" onChange={(e) => setEmail(e.target.value)} value ={email}/>
</div>
<div className={styles.input_container}>
  ...
  <input placeholder="Password" title="Input title" name="input-name" type="password" className={styles.input_field} id="password_field" onChange={(e) => setPassword(e.target.value)} value={password}/>
</div>
<button title="Sign In" onClick={logIn} className={styles.sign_in_btn}>
  <span>Sign In</span>
</button>
<p className={styles.subtitle}>Don't have an account? <span className={styles.link} onClick={() => switchToRegister()}>Create one!</span></p>
